...
namespace InstancedModelSample
{
    ...
    public class InstancedModelSampleGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //catTex = Content.Load<Texture2D>("cat_0");
            var effect = instancedModel.Meshes[0].MeshParts[0].Effect;
            //catTex = effect.Parameters["Texture"].GetValueTexture2D();
            ...
            /*var effect = Content.Load<Effect>("InstancedModel");
        ...
        void DrawOverlayText()
        {
            ...
            //spriteBatch.DrawString(spriteFont, $"Ambient: {ambient}", new Vector2(325, 325), Color.Black);
            //spriteBatch.DrawString(spriteFont, $"Ambient: {ambient}", new Vector2(324, 324), Color.White);
            //spriteBatch.Draw(catTex, new Vector2(200, 100));
